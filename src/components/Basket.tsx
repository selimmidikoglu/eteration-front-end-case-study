          ...
          selectedProducts.map((product, id) => (
            <div className="w-full max-h-40 grid grid-cols-4 sm:grid-cols-4 p-2 mt-2">
              ...
              <div className="col-span-2 grid grid-cols-3 mx-auto">
                ...
                <span className="col-span-1 flex items-center justify-center product-quantity-container">
                  {product.quantity}
                </span>
                <button
                  className="col-span-1 flex items-center justify-center quantity-changer"
            ...
            <div className="w-full max-h-40 flex flex-col items-center justify-center">
              <div className="total-price-container mb-5">
                <label className="total-price-label text-center">
                  Total Price:{" "}
                  <span className="total-price text-blue-600 font-bold">
                    {totalPrice} &#8378;
                  </span>
                </label>
              </div>
              <button className="checkout-button w-40 flex justify-center items-center gap-2 px-4 h-8 bg-blue-600 rounded-md text-white">
                Checkout
              </button>
            </div>
          </div>
